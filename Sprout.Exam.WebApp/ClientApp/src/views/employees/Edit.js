...
export class EmployeeEdit extends Component {
    ...
    async saveEmployee() {
        ...
        if (this.state.fullName === "") {
            alert("Full Name should be not empty.")
        }
        else if (this.state.tin === "") {
            alert("TIN should be not empty.")
        }
        else if (this.state.birthdate === "") {
            alert("birth Date should be not empty.")
        }
        else if (this.state.employeeTypeId === "") {
            alert("Employee Type should be not empty.")
        }
        else {
    ...
    async getEmployee(id) {
        ...
        this.setState(state => ({ id: data.id, fullName: data.fullName, birthdate: data.formattedBirthdate, tin: data.tin, employeeTypeId: data.employeeTypeId, loading: false, loadingSave: false }));
    }
}
